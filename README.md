...
| **更新源**   | **链接**                                                                                                         | **介绍**               |
| ------------ | ---------------------------------------------------------------------------------------------------------------- | ---------------------- |
| Greasyfork   | [前往 Greasyfork 安装](https://greasyfork.org/zh-CN/scripts/479861)                                              | 稳定版                 |
| Github       | [点击安装](https://raw.githubusercontent.com/festoney8/bilibili-cleaner/release/bilibili-cleaner.github.user.js) | 测试版                 |
| JSDelivr CDN | [点击安装](https://cdn.jsdelivr.net/gh/festoney8/bilibili-cleaner@release/bilibili-cleaner.jsdelivr.user.js)     | 测试版，解决连接性问题 |
...
- 若强行使用，建议 Firefox/Edge 手机版 + 篡改猴扩展

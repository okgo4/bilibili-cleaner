...
- 新增：直播页 隐藏播放器内sticker
- 新增：搜索页 专栏过滤
- 修复：直播页 禁用播放器皮肤按钮颜色问题
- 修复：播放页 自动网页全屏时方向键调音量问题
- 优化：直播页 播放器背景图
- 更新：部分功能细节
...
- 新增：清理插件存储中的弃用项
- 修复：首页 隐藏全部骨架影响轮播图
- 优化：视频过滤与 greasyfork 481629 的兼容性
- 更新：部分功能细节
